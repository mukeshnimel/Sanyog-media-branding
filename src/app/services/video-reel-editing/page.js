...
function PortfolioVideoCard({ src, index, ratio }) {
    ...
    return (
        ...
        >
            ...
            >
                <div className="w-12 h-12 sm:w-14 sm:h-14 xl:w-16 xl:h-16 4xl:w-20 4xl:h-20 rounded-full bg-white/90 flex items-center justify-center shadow-xl">
        ...
        <main className="flex-1 bg-slate-950 text-slate-100 overflow-x-hidden">
                ...
                <div className="relative z-10 max-w-4xl xl:max-w-5xl 4xl:max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center mt-5 sm:mt-4 lg:mt-0">
                    ...
                    >
                        ...
                        <span className="flex items-center justify-center">
                            <img src="/images/video-reel/icons/smile.svg" alt="Smile" className="w-5 h-5 sm:w-7 sm:h-7 xl:w-9 xl:h-9 4xl:w-11 4xl:h-11 brightness-0 invert" />
                        </span>
                    </button>
                    ...
                    <div className="flex -space-x-3 mb-4">
                        {avatarImages.map((src, i) => (
                            <div
                                key={i}
                                className="w-8 h-8 sm:w-10 sm:h-10 xl:w-12 xl:h-12 4xl:w-14 4xl:h-14 rounded-full overflow-hidden border-2 border-slate-950 relative"
                            >
            ...
            <section className="py-16 sm:py-20 md:py-24 4xl:py-32 bg-slate-950 border-b border-slate-800">
                <div className="max-w-7xl 2xl:max-w-[1900px] 3xl:max-w-[2200px] 4xl:max-w-[2600px] mx-auto px-4 sm:px-6 xl:px-16 4xl:px-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 xl:gap-8 4xl:gap-10 items-stretch md:items-center">
                        {useCases.map((uc, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className={`
                            group relative flex flex-col items-center text-center gap-3 sm:gap-4 xl:gap-5
                            p-6 sm:p-8 xl:p-9 4xl:p-11 rounded-2xl sm:rounded-3xl cursor-pointer
                        ...
                        `}
                                >
                                    <div className="w-12 h-12 sm:w-14 sm:h-14 xl:w-16 xl:h-16 4xl:w-20 4xl:h-20 flex items-center justify-center relative">
                                        <Image
            ...
            <section className="py-16 sm:py-20 md:py-24 4xl:py-32 bg-slate-900 border-b border-slate-800">
                <div className="max-w-7xl 2xl:max-w-[1900px] 3xl:max-w-[2200px] 4xl:max-w-[2600px] mx-auto px-4 sm:px-6 xl:px-16 4xl:px-24">
                    ...
                    {/* video now sits in its own relative, aspect-ratio-controlled box —
                        ...
                        height on mobile */}
                    <div
                        className="group relative w-full aspect-video rounded-2xl sm:rounded-3xl overflow-hidden mb-8 sm:mb-10 4xl:mb-14 cursor-pointer"
                    ...
                    >
                        ...
                        {/* <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/30">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 xl:w-20 xl:h-20 4xl:w-24 4xl:h-24 rounded-full bg-white/90 flex items-center justify-center shadow-xl">
                                {explainerPlaying ? (
                                    <Pause className="w-5 h-5 sm:w-6 sm:h-6 xl:w-7 xl:h-7 4xl:w-9 4xl:h-9 text-slate-950" fill="currentColor" />
                                ) : (
                                    <Play className="w-5 h-5 sm:w-6 sm:h-6 xl:w-7 xl:h-7 4xl:w-9 4xl:h-9 text-slate-950 ml-1" fill="currentColor" />
                                )}
                            </div>
                        </div> */}
                    </div>
            ...
            <section id="reelportfolio" className="py-16 sm:py-20 md:py-24 4xl:py-32 bg-slate-900 border-b border-slate-800">
                <div className="max-w-7xl 2xl:max-w-[1900px] 3xl:max-w-[2200px] 4xl:max-w-[2600px] mx-auto px-4 sm:px-6 xl:px-16 4xl:px-24">
                    ...
                    <div className="flex flex-wrap gap-3 sm:gap-4 xl:gap-5 4xl:gap-6">
