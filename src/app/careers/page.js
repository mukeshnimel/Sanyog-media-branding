...
export default function CareersPage() {
  ...
  return (
    <main className="flex-1 bg-dark-bg text-slate-100 overflow-hidden">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative py-24 md:py-35 flex items-center justify-center bg-dark-bg border-b border-glass-border overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 rounded-full bg-neon-cyan/10 blur-[130px] pointer-events-none" />
        ...
        {/* Content */}
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center flex flex-col items-center -translate-y-8">
          ...
          <motion.h1
            ...
            className="font-display font-extrabold text-4xl md:text-6xl lg:text-7xl leading-tight tracking-tight text-white mb-6 max-w-4xl"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center gap-2 px-10 py-5 rounded-full border border-glass-border bg-slate-900/40 text-xl font-semibold text-white mb-10"
          >
          ...
          >
            <a
              href="#openings"
              className="glow-btn-primary px-8 py-4 rounded-xl text-sm font-bold text-white flex items-center justify-center gap-2"
            >
              Explore Openings
            ...
            <a
              href="#apply"
              className="px-8 py-4 rounded-xl text-sm font-bold text-slate-300 border border-glass-border hover:border-white hover:text-white transition-all bg-white/5 backdrop-blur-sm"
            >
              Send Your C.V.
            </a>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col items-start">
              <span className="text-lg md:text-xl font-bold text-white mb-3">
                Career at Sanyog Media
              </span>

              <h2 className="font-display font-bold text-3xl md:text-5xl text-sky-400 leading-tight mb-6">
                Special Advantages to Advance Your Entire Career
              </h2>

              {/* Highlighted quote/callout box */}
              <div className="w-full rounded-lg bg-[#0b2a4a] px-6 py-5 mb-6">
            ...
            <div className="w-full flex flex-col gap-6">
              <div className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-glass-border shadow-xl">
                <Image
              ...
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-full bg-white border border-glass-border flex items-center justify-center text-sky-500 shrink-0">
                  <Mail className="w-5 h-5" />
                </div>
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-white">Send Your C.V.</span>

                  <a href="mailto:careers@sanyogmedia.com"
                    className="text-sm md:text-base font-semibold text-sky-400 hover:text-sky-300 transition-colors"
                  >
      ...
      {/* 3. UNIQUE PERKS & CULTURE */}
      <section className="py-24 bg-dark-bg relative overflow-hidden border-b border-glass-border">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {perks.map((perk, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="group rounded-xl overflow-hidden border border-glass-border bg-slate-900/40 cursor-default transition-all duration-300 hover:-translate-y-1.5 hover:border-neon-cyan/40 hover:shadow-[0_0_30px_-8px_theme(colors.neon-cyan)]"
                >
                  {/* Fake browser chrome bar */}
                  <div className="flex items-center gap-3 px-4 py-2.5 bg-slate-950/60 border-b border-glass-border">
                    <div className="flex gap-1.5 shrink-0">
                      <span className="w-2 h-2 rounded-full bg-slate-600 group-hover:bg-red-400/70 transition-colors duration-300" />
                      <span className="w-2 h-2 rounded-full bg-slate-600 group-hover:bg-amber-400/70 transition-colors duration-300" />
                      <span className="w-2 h-2 rounded-full bg-slate-600 group-hover:bg-emerald-400/70 transition-colors duration-300" />
                    </div>
                    <div className="flex-1 min-w-0 rounded-md bg-slate-900/80 px-2.5 py-1">
                      <span className="block text-[10px] text-slate-500 truncate group-hover:text-neon-cyan/80 transition-colors duration-300">
                  ...
                  {/* Page content */}
                  <div className="p-6">
                    <div className="w-11 h-11 rounded-xl bg-slate-900 border border-glass-border flex items-center justify-center mb-5 text-white transition-transform duration-300 group-hover:scale-110">
      ...
      <section className="py-24 bg-dark-bg border-b border-glass-border relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-electric-blue/5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center pb-10 mb-14 border-b ">
            <motion.h2
              ...
              className="font-display font-bold text-2xl md:text-6xl text-white"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true, margin: "-100px" }}
              transition={{ delay: 0.1 }}
              className="text-base md:text-5xl font-bold text-white mt-2"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <div className="bg-sky-600 p-5 mb-8 w-full border-l-[5px] border-white">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-sky-500 hover:bg-sky-600 text-white text-sm font-bold transition-colors"
              >
                Apply Now
      ...
      <section id="openings" className="py-24 bg-slate-950 relative">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-neon-cyan">
              Join the Success with Sanyog Media Concepts
            </span>
            <h2 className="font-display font-extrabold text-3xl md:text-5xl text-white mt-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {roles.map((role, idx) => (
              <motion.div
                ...
                className="bg-white rounded-3xl border-2 border-sky-400 overflow-hidden shadow-xl flex flex-col"
              >
                {/* Photo */}
                ...
                {/* Content */}
                <div className="flex flex-col items-center px-6 pt-6 pb-8 flex-1">
                  <h3 className="font-display font-bold text-lg text-slate-800 text-center mb-4">
                    {role.title}
                  </h3>

                  <div className="w-full flex flex-col mb-6">
                    <div className="flex items-center gap-2 py-2 border-b border-slate-200 text-sm text-slate-600">
                      <ArrowRightCircle className="w-4 h-4 text-sky-500 shrink-0" />
                      {role.posts}
                    </div>
                    <div className="flex items-center gap-2 py-2 border-b border-slate-200 text-sm text-slate-600">
                      <ArrowRightCircle className="w-4 h-4 text-sky-500 shrink-0" />
                  ...
                  <div className="mt-auto">
                    {role.status === "filled" ? (
                      <span className="inline-flex items-center px-6 py-2.5 rounded-full text-sm font-bold text-white bg-orange-500">
                        Filled
                      </span>
                    ) : (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center px-6 py-2.5 rounded-full text-sm font-bold text-white bg-sky-500 hover:bg-sky-600 transition-colors"
                      >
                        Apply Now
                      </a>
                    )}
